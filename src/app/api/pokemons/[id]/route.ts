...
export const GET = async (
  ...
  const { id } = params
  const { searchParams } = new URL(request.url) //  요청된 URL 내용 확인 ->  searchParams는 URL객체의 속성으로 URL의 쿼리 문자열
  console.log("searchParams", searchParams) // searchParams URLSearchParams { 'liked' => 'true' }
